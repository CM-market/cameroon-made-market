    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .execute(Statement::from_string(
                ...
                r#"CREATE TYPE user_role AS ENUM ('Admin', 'Vendor');"#,
            ))
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Products::ImageUrls).array(ColumnType::String(None)).not_null())
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Carts::SessionId).uuid().not_null().unique_key())
                    .col(
